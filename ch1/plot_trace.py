...
ax1.plot(x,t,'-',linewidth=2,color='k',label="Leapfrog")
# ax1.plot(xf,t,'--',lineWidth=2,color='0.5',label="Forward Euler")
# ax1.plot(xb,t,':',lineWidth=2,color='0.8',label="Backward Euler")
